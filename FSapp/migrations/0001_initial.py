    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_batch_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='FSapp.batch')),
            ],
        ),
        migrations.CreateModel(
            name='modelcomplaints',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('complaints', models.TextField()),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FSapp.register_details')),
            ],
        ),
        migrations.CreateModel(
            name='medical_doubts',
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medical_doubts', to='FSapp.register_details')),
            ],
        ),
        migrations.CreateModel(
            name='Instructor',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Batch', to='FSapp.batch')),
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Register_details', to='FSapp.register_details')),
            ],
        ),
        migrations.CreateModel(
            name='Bill',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField()),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='atendance', to='FSapp.register_details')),
            ],
        ),
        migrations.CreateModel(
            name='appoinments',
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appoinment', to='FSapp.register_details')),
            ],
        ),
    ]
